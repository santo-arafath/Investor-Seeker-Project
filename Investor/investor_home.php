...
<html>
    ...
    <head>
       <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <link rel="stylesheet" href="investorHomestyle.css">
                   ...
                   <div class="main">
                    <div class="topbar">
                      ...
                      <div class="dropdown_menu">
                        ...
                        <li><a href="#"><ion-icon class="ic" name="logo-bitbucket"></ion-icon>Cards</a></li>
                   ...
                   <div class="main_body_f">
                    <div class="container1">
                            ...
                            <div class="get-starts">
                                <h1>Apply to Invest</h1>
                                <input type="submit" class="get-starts-button" value="get started">
