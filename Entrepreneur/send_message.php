...
if(isset($_REQUEST['sendmessage']))
{
    ...
    $query="INSERT INTO `chat_history_and_relational_table` (`entrepreneur_id`, `investor_id`, `sender_id`, `receiver_id`, `message`, `send_date`, `send_time`) VALUES ('$sender', '$receiver', '$sender', '$receiver', '$_message', '$_date', '$_time')";
